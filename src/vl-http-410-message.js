...
define('vl-http-410-message', class extends VlHttpErrorMessage {
  constructor() {
    super({
      ...
      imageAlt: '',
      text: `<p>Deze pagina bestaat niet meer. <a href="mailto:help@omgevingvlaanderen.be?subject=HTTP-code 410">Mail de helpdesk</a> en vermeld daarbij de URL in de adresbalk hierboven en de foutcode 410.</p>`,
